                ...
                {currentChatId && (
                    <div className="absolute top-4 right-4 z-50 flex items-center gap-2 animate-fade-in">
                        <button
                            onClick={handleShare}
                            disabled={isSharing}
                            className="flex items-center gap-2 px-4 py-2 bg-[#191C1C]/80 backdrop-blur-xl border border-white/10 rounded-xl text-sm font-semibold text-gray-300 hover:text-white hover:bg-white/5 transition-all shadow-2xl group"
                        >
